...
export const BSCLogo: FC<{}> = () => {
    return (<>
        <svg version="1.0" id="katman_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
            viewBox="0 0 800 600" style={{
                background: "0 0 800 600"
            }} >
            <style type="text/css">
                {".st0{fill-rule:evenodd;clip-rule:evenodd;fill:#F3BA2F;} .st1{fill - rule:evenodd;clip-rule:evenodd;fill:#131415;}"}
            </style>
            <g id="Light">
                    ...
                    <g id="Block" transform="translate(41.000000, 1263.000000)">
                        <g id="TVL" transform="translate(48.000000, 252.000000)">
                            <g id="Icons_x2F_Icon-24_x2F_cake" transform="translate(368.000000, 0.000000)">
                                <circle id="Oval" className="st0" cx="399.8" cy="299.6" r="230.7" />
                                <g id="Icons_x2F_icon-24_x2F_networks_x2F_binance_x5F_smart_x5F_chain" transform="translate(3.333333, 3.333333)">
                                    <path id="Combined-Shape" className="st1" d="M456.3,320.8l34.8,34.7L396.5,450L302,355.5l34.8-34.7l59.7,59.7L456.3,320.8z
